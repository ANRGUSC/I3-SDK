...
def publish_data():
    ...
    account = 'seller'
    pw = 'zdacm8'
    topic = 'i3/lacity/service_requests/multiple_streetlight_issue'
    ...
    url='https://data.lacity.org/resource/d4vt-q4t5.json?$where=createddate > "'  +  earliest_createddate  + '" AND requesttype = "Multiple Streetlight Issue"'
