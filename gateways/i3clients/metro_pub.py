"""
metro_pub.py is an example of a publisher of la metro predictions for a given stop
...
if __name__ == '__main__':
    ...
    account = 'seller'
    pw = 'zdacm8'
    topic = 'i3/lacity/metro_predictions'
    ...
    url='http://api.metro.net/agencies/lametro/stops/29/predictions/'
