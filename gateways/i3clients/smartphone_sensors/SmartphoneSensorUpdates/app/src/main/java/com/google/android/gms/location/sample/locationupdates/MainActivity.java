...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private String thingTopic = "v1/devices/me/attributes";
    private String neptune = "tcp://neptune.usc.edu:3883";
    private String imscBroker = "tcp://imscspark3.usc.edu:1880";
    private String thingsboard = "tcp://demo.thingsboard.io:1883";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mConnectionTextView = (TextView) findViewById(R.id.connection);
        ...
        client =
                new MqttAndroidClient(this.getApplicationContext(), imscBroker,
                        clientId);

        options = new MqttConnectOptions();
        options.setMqttVersion(MqttConnectOptions.MQTT_VERSION_3_1);
        options.setUserName("erikalar");
        options.setPassword("clntcp".toCharArray());
        try {
            IMqttToken token = client.connect(options);
            Log.d(TAG,"tried connect");
            token.setActionCallback(new IMqttActionListener() {
                ...
                public void onFailure(IMqttToken asyncActionToken, Throwable exception) {
                    ...
                    Log.d(TAG, "onFailure");
                    mConnectionTextView.setText("Failed to connect");
                }
            });
        ...
        client.setCallback(new MqttCallback() {
            ...
            public void connectionLost(Throwable arg0) {
                ...
                mConnectionTextView.setText("Connection lost");
                try {
                    client.connect();
                    mConnectionTextView.setText("Connected");
                } catch (MqttException e) {
                    ...
                    e.printStackTrace();
                    mConnectionTextView.setText("Unable to reconnect");
                }
            }
            @Override
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            ...
            mPressureTextView.setText(String.format(Locale.ENGLISH, "%s: %f mbar", mPressureLabel, millibars_of_pressure));
            mLightTextView.setText(String.format(Locale.ENGLISH, "%s: %f lm", mLightLabel, lumens));
            ...
            payload = String.format(Locale.ENGLISH, "{\"Location\": {\"%s\": %f , \"%s\": %f}, \"%s\": \"%s\", \"%s\": %f, \"%s\": %f}",
                    ...
                    mCurrentLocation.getLongitude(), "Datetime", mLastUpdateTime,
                    "Light_Sensor", lumens, "Barometer", millibars_of_pressure);
    ...
    private void stopLocationUpdates() {
        ...
        Log.d(TAG, "Before calling removeLocation");
    ...
    public void onResume() {
        ...
        try {
            ...
            mConnectionTextView.setText("Unable to connect");
            e.printStackTrace();
        }
    ...
    protected void onPause() {
        ...
        mConnectionTextView.setText("Disconnected");
    }
